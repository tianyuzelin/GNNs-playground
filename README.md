...
- `2021-10-22 GCN-PyTorch-Jiaxu` [[Folder](./GCN-PyTorch-Jiaxu)] Graph Convolutional Network (GCN) implementation in PyTorch, similar to https://arxiv.org/abs/1609.02907.

- `2021-10-27 DGI-PyTorch-Jiaxu` [[Folder](./DGI-PyTorch-Jiaxu)] Deep Graph Infomax (DGI) implementation in PyTorch, similar to https://arxiv.org/abs/1809.10341.
